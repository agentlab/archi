 ...
 * 
 * NOTE!
 * This is copied and pasted from org.eclipse.ui.actions.TextActionHandler class in the org.eclipse.ui.ide plug-in.
 * We don't want to include the whole org.eclipse.ui.ide plug-in just for this one class.
 */
        ...
        public void updateEnabledState() {
            if (activeTextControl != null && !activeTextControl.isDisposed()) {
                setEnabled(activeTextControl.getEditable()
                        ...
                        || activeTextControl.getCaretOffset() < activeTextControl
                                .getCharCount()));
                return;
            }
            if (deleteAction != null) {
