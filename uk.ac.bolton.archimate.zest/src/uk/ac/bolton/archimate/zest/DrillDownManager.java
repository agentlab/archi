...
public class DrillDownManager implements ISelectionChangedListener {
    ...
    DrillDownManager(ZestGraphViewer viewer) {
        fGraphViewer = viewer;
    ...
    private void makeActions() {
        fActionHome = new Action("Go Home") {
            @Override
            public void run() {
                goHome();
            }
            ...
            public ImageDescriptor getImageDescriptor() {
                return AbstractUIPlugin.imageDescriptorFromPlugin(ArchimateZestPlugin.PLUGIN_ID, "img/home_nav.gif");
            }
        };
        
        fActionHome.setEnabled(false);
        
        fActionBack = new Action("Go Back") {
            @Override
            public void run() {
                goBack();
            }
            ...
            @Override
            public ImageDescriptor getImageDescriptor() {
                return AbstractUIPlugin.imageDescriptorFromPlugin(ArchimateZestPlugin.PLUGIN_ID, "img/backward.gif");
            }
        };
        
        fActionBack.setEnabled(false);

        fActionGoInto = new Action("Go Into") {
            @Override
            public void run() {
                goInto();
            }
            ...
            @Override
            public ImageDescriptor getImageDescriptor() {
                return AbstractUIPlugin.imageDescriptorFromPlugin(ArchimateZestPlugin.PLUGIN_ID, "img/forward.gif");
            }
        };
